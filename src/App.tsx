              ...
              <textarea
                placeholder={
                  form.type === 'code'
                    ...
                    : 'Full course content / notes. Use $...$, $$...$$, \\(...\\), or equation environments like \\begin{equation}/\\end{equation}, \\begin{align}/\\end{align}, and \\begin{gather}/\\end{gather} (including starred variants). Add figures with ![alt](https://image-url "caption") or ![alt](./image.png "caption").'
                }
                value={form.content}
